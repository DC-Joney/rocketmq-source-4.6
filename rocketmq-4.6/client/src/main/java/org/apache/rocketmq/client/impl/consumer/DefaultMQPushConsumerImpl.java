...
public class DefaultMQPushConsumerImpl implements MQConsumerInner {
    ...
    public void pullMessage(final PullRequest pullRequest) {
        ...
        //反向导航：从pullRequest获得ProcessQueue
        //ProcessQueue表示topic的queue的缓存消息，消息统计
        ...
        if (!this.consumeOrderly) {
            ...
            // 判断processQueue 是否跨过了最大的消息跨度
            // 经过offset的大小， 缓存的消息 offset的最大跨度不能够超过 consumeConcurrentlyMaxSpan = 2000
            ...
            //顺序消费模式
            // 针对于顺序消息
            // 若是是顺序消息，那么 processQueue  就是须要上锁
        ...
        // 通过 负载均衡器 rebalanceImpl  获取 topic的订阅消息
                    ...
                    switch (pullResult.getPullStatus()) {
                        case FOUND:
                            ...
                            if (pullResult.getMsgFoundList() == null || pullResult.getMsgFoundList().isEmpty()) {
                                ...
                                //提交到了  第二大服务类，consumeMessageService
