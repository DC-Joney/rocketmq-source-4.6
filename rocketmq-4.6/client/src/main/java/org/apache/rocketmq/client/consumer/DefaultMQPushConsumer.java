 ...
 * </p>
 *
 * Technically speaking, this push client is virtually a wrapper of the underlying pull service.
 * Specifically, on
 * arrival of messages pulled from brokers,
 * it roughly invokes the registered callback handler to feed the messages.
 * </p>
 *
 ...
 *
 * <p>
 * <strong>Thread Safety:</strong> After initialization,
 * the instance can be regarded as thread-safe.
 * </p>
 */
