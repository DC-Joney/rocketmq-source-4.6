...
public class RequestCode {
    ...
    public static final int SEND_MESSAGE = 10; // 消息发送

    public static final int PULL_MESSAGE = 11; //消费者消息拉取
    ...
    public static final int REGISTER_BROKER = 103; // 代理注册, 元数据注册

    public static final int UNREGISTER_BROKER = 104;  // 取消代理注册 ，元数据剔除
    public static final int GET_ROUTEINTO_BY_TOPIC = 105; //根据 topic 获取路由信息 ，元数据获取
